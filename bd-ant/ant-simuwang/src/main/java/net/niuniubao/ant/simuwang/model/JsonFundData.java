...
public class JsonFundData {
    ...
    private Long fundListId;

    public Long getFundListId() {
        return fundListId;
    }

    public void setFundListId(Long fundListId) {
    ...
    public void setDataVersion(String dataVesion) {
        this.dataVersion = dataVesion;
    }
