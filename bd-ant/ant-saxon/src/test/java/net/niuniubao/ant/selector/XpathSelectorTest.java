...
/**
 * @author dev@niuniubao.net <br> Date: 13-4-21 Time: 上午10:06
 */
public class XpathSelectorTest {
    ...
    @Test
    public void testSschina() {
        Html html1 = new Html(html);
        Object  object = html1.xpath("//div[contains(text(),'声明：ITeye')]/text()");
        System.out.println(object);
        Assert.assertEquals("再次吐槽easyui", html1.xpath("//div[contains(text(),'声明：ITeye')]/text()").toString());
        Assert.assertNotNull(html1.$("a[href]").xpath("//@href").all());
        Selectors.xpath("/abc/").select("");
    }
    ...
    public void testXPath12() {
        String text = "<h1>眉山：扎实推进农业农村工作 促农持续增收<br>\n" +
                "<span>2013-07-31 23:29:45&nbsp;&nbsp;&nbsp;来源：<a href=\"http://www.mshw.net\" target=\"_blank\" style=\"color:#AAA\">眉山网</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;责任编辑：张斯炜</span></h1>";
        Xpath2Selector xpathSelector = new Xpath2Selector("//table[1]/tbody/tr[descendant::td[contains(text(),'暂行办法实施前成立的基金:')]]//text()");
        System.out.println(xpathSelector.select(html));
    }
